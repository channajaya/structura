...
import { SITE_ORIGIN } from "@/config/publicLaunch";
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  title: {
    default: "STRUCTURA — Digital Engineering Office",
    template: "%s | STRUCTURA",
  },
  description:
    "Integrated engineering workspaces, visual calculators, drawing tools and professional learning resources.",
};
